...
export const resumeLink =
  "https://drive.google.com/file/d/1FrZXQ0tN-9MtwwOsg549zeuDe1rwkDVo/view?usp=sharing";
export const skills = [
  {
    id: 1,
    tech: "Docker",
...
export const projects = [
 ...
 
  {
    ...
    tech_stack: ["Python","FastAPI", "AWS RDS", "SNS", "SQS", "Lambda", "EventBridge", "SES","CloudFront","CloudWatch","AWS WAF","S3","Route 53"],
